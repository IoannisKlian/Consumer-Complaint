...
<nav class="navbar navbar-expand-lg navbar-light bg-dark" style="padding-bottom: 0; margin-bottom: 0; border-top: solid; padding-top: 0; margin-top: 0;">
  <div class="collapse navbar-collapse" id="navbarNavDropdown1" style="padding-top: 0; margin-top: 0;">
    <ul class="navbar-nav nav-fill w-100" style="padding-top: 0; margin-top: 0;">

      <!-- Add User -->
      <li class="nav-item" id="add-user" style="border-right: solid; padding-top: 0; margin-top: 0;">
